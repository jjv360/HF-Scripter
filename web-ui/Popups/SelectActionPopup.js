...
export default class SelectActionPopup extends Popup {
    ...
    render() {
        ...
        return <div>
            ...
            <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: 40, paddingTop: 20, display: "flex", alignItems: "center", borderBottom: "1px solid rgba(0, 0, 0, 0.1)" }}>
                ...
                {/* Title label */}
                <div style={{ padding: "0px 14px 0px 24px", fontSize: 16, color: "#444", flexShrink: "1", flexGrow: "1", textAlign: "left" }}>Select Action</div>
