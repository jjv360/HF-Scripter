...
class PluginManager {
    ...
    constructor() {
        ...
        this.add(require("./ActionEditEntity").default)
        this.add(require("./ActionGetEntityData").default)
        this.add(require("./ActionHFUIAlert").default)
        this.add(require("./ActionHFUISubtitle").default)
        this.add(require("./ActionIf").default)
        ...
        this.add(require("./ActionSetEntityData").default)
        this.add(require("./ActionSetJointRotation").default)
        this.add(require("./ActionSetVariable").default)
        this.add(require("./ActionToggleBoolean").default)
        this.add(require("./TriggerLeaveEntity").default)
        this.add(require("./TriggerEnterEntity").default)
        this.add(require("./TriggerMessageOnServer").default)
